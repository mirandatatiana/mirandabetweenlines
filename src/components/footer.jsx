...
<footer class=" relative isolate bg-gradient-to-l from-indigo-400 to-indigo-950">
    ...
    <div class=" p-4 py-6 lg:py-8">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="https://www.linkedin.com/in/tatianayamila-miranda" class="text-gray-950 hover:text-gray-900 dark:hover:text-white ms-5">
<svg fill="#000000" class="w-8 h-8" aria-hidden="true" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 310 310">
<g id="XMLID_801_">
...
<span class="sr-only">Linkedin account</span>
              ...
              <a href="#https://github.com/mirandatatiana" class="text-gray-950 hover:text-gray-900 dark:hover:text-white ms-5">
