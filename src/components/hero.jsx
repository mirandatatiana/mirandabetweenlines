...
<section class="bg-white border-none bg-gradient-to-l from-indigo-400 to-indigo-950 ">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto items-center  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center  lg:col-span-7">
            ...
            <h2 class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
            Actually a I’m a creative person. One how love to code
